...
Note that here the problem is not convex, as $\{ \xx: \norm{\xx}_2^2 = 1 \}$ is not convex.
...
\footnote{Again, Wikipedia is helpful here: \href{https://en.wikipedia.org/wiki/Slater's_condition}{https://en.wikipedia.org/wiki/Slater's\_condition}}.
